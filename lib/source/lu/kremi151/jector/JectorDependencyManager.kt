...
internal class JectorDependencyManager(
    ...
    override fun collectProviders(obj: Any) {
    ...
    override fun collectProviders(factories: List<BeanFactory<*>>, priority: Priority, lazy: Boolean) {
    ...
    override fun initializeBeans(autoConfigurator: AutoConfigurator) {
            ...
            for (factory in factories) {
                if (factory.lazy) {
                    ...
                    val bean = Proxy.newProxyInstance(
                            ...
                            @Suppress("UNCHECKED_CAST")
                            (LazyConfigurableValue(autoConfigurator, factory.factory as BeanFactory<Any>))
                    )
        ...
        for (bean in allBeans) {
            autoConfigurator.autoConfigure(bean.bean!!)
        }
    }
    ...
    override fun autoConfigureField(obj: Any, field: Field, annotation: Inject) {
